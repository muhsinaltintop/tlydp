...
class Utils {
  ...
  static List <DucksToFind> getDucksToFind() {
    return [
      DucksToFind(
        maker: "van3ssa",
        duckName: "Juan",
        locationPlaced: "London",
        clues: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean tristique finibus nulla et consectetur. Nam id ligula velit.",
      ),
      DucksToFind(
        maker: "lizz0000",
        duckName: "Habanero",
        locationPlaced: "Leeds",
        clues: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean tristique finibus nulla et consectetur. Nam id ligula velit. Duis eu lacus gravida nibh fermentum venenatis ut sed velit.",
      )
    ];
  }
}